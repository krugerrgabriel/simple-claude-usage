...
**Requisitos:** GNOME Shell 42+ (Ubuntu 22.04+, Fedora 36+…) e [Claude Code](https://claude.com/claude-code) logado.
...
Não, é uma extensão do GNOME Shell. GNOME 42–48 são suportados.
