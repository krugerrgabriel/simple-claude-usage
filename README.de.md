...
**Voraussetzungen:** GNOME Shell 42+ (Ubuntu 22.04+, Fedora 36+…) und [Claude Code](https://claude.com/claude-code) mit aktivem Login.
...
Nein, es ist eine GNOME-Shell-Extension. GNOME 42–48 werden unterstützt.
